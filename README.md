...
| **Landing Pages HUB** | A monorepo of production-grade landing pages with isolated route groups, distinct design systems, and Vercel deployment. Features **Densify** (Liquid Glass fitness app) and **LegisFlow** (Corporate Brutalism compliance SaaS). | Next.js 16, React 19, TypeScript, Tailwind CSS 4, Framer Motion, Radix UI, Zod | [Live](https://landingpages-hub.vercel.app) |
